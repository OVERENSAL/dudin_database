...
WHERE hotel.name = 'Êîñìîñ' AND room_category.name = 'Ëþêñ' AND (room_in_booking.checkin_date <= '2019-04-01' AND room_in_booking.checkout_date > '2019-04-01');
...
SELECT COUNT(room_in_booking.id_room) AS clients,
	...
	WHERE
		hotel.name = 'Êîñìîñ' AND ('2019-03-23' BETWEEN room_in_booking.checkin_date AND room_in_booking.checkout_date)
	GROUP BY
...
BEGIN TRANSACTION
	INSERT INTO client VALUES ('Ïóïêèí Ëóïà Ãåííàäüåâè÷', '3(224)228334')
